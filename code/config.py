...
training_iters = 50000  # The training iterations number
...
weights = {
    ...
    'b_conv1': tf.Variable(tf.truncated_normal([3, 3, 64, 32], stddev=0.01), trainable=True),

    'b_conv0': tf.Variable(tf.truncated_normal([3, 3, 64, 3], stddev=0.01), trainable=True),
